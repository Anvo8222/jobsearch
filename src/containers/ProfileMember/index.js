    ...
    <>
      <Wrap>
        ...
        <div className="w-full">
          ...
          {(option === 1 && <ViewCv currentUser={currentUser}></ViewCv>) ||
            (option === 2 && <MyProfile currentUser={currentUser} />) ||
            (option === 3 && (
              <Notification currentUser={currentUser}></Notification>
            )) ||
            (option === 4 && <MyJob currentUser={currentUser}></MyJob>)}
        </div>
      </Wrap>
    </>
  );
